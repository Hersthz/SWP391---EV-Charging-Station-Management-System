...
        ${paymentMethod === "card"
    ...
    const renderSelectionStep = () => (
        <motion.div
            ...
            className="space-y-10" // Tăng khoảng cách để thoáng hơn
        >
            <Card className="rounded-2xl border border-zinc-200/80 bg-white shadow-lg shadow-zinc-900/5">
                <CardContent className="p-6">
                    <div className="flex items-center justify-between">
                        ...
                        <Badge variant="outline" className="rounded-full border-emerald-500/30 text-emerald-700 bg-emerald-500/10 font-medium">
            ...
            <Card className="border border-red-500/30 bg-red-500/10 rounded-xl">
                <CardContent className="p-4 flex items-start gap-3">
                    ...
                    <div className="text-sm">
                        ...
                        <div className="text-zinc-700">Phí giữ chỗ: <b>{formatVND(insufficient.holdFee)}</b></div>
...
                              hover:shadow-xl hover:shadow-cyan-500/40 hover:-translate-y-0.5 transform transition-all duration-300 shadow-lg shadow-cyan-500/30"           >
    ...
    const renderStepContent = () => {
        // === Dùng AnimatePresence để quản lý animation giữa các step ===
        switch (currentStep) {
            case "selection":
