          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2">
                ...
                <Badge className="bg-accent/10 text-accent-foreground border-accent/20">Staff Portal</Badge>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2 text-sm">
                <div className="text-right">
                  <div className="font-medium text-foreground">John Anderson</div>
                  <div className="text-xs text-muted-foreground">Station Supervisor</div>
                </div>
