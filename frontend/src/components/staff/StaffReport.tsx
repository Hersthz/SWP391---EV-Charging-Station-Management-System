            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground flex items-center mt-1">
                  <TrendingUp className="h-3 w-3 mr-1 text-[hsl(var(--success))]" />
                ...
                <CardContent>
                  <ChartContainer config={chartConfig} className="h-[400px] w-full">
                    <AreaChart data={revenueData}>
                      ...
                      <Area type="monotone" dataKey="revenue" stroke="hsl(var(--chart-1))" strokeWidth={2} fillOpacity={0.25} fill="url(#colorRevenue)" />
                    </AreaChart>
                  </ChartContainer>
                </CardContent>
              </Card>
                ...
                <CardContent>
                  <ChartContainer config={chartConfig} className="h-[400px] w-full">
                    <BarChart data={hourlyUsageData}>
                      ...
                      <ChartTooltip content={<ChartTooltipContent />} />
                      <Bar dataKey="usage" fill="hsl(var(--chart-2))" radius={[6, 6, 0, 0]} opacity={0.9} />
                    </BarChart>
                  </ChartContainer>
                </CardContent>
              </Card>
                ...
                <CardContent>
                  <ChartContainer config={chartConfig} className="h-[400px] w-full">
                    <BarChart data={stationUsageData}>
                      ...
                      <YAxis className="text-xs" />
                      <ChartTooltip content={<ChartTooltipContent />} />
                      <Bar dataKey="sessions" fill="hsl(var(--chart-1))" radius={[6, 6, 0, 0]} opacity={0.9} />
                      <Bar dataKey="revenue" fill="hsl(var(--chart-2))" radius={[6, 6, 0, 0]} opacity={0.85} />
                    </BarChart>
                  </ChartContainer>
                </CardContent>
              </Card>
                    ...
                    <PieChart>
                      <Pie
                        ...
                        label={(p: PieLabelRenderProps) => {
                          const pct = Number(p.percent ?? 0);        // ← ÉP VỀ NUMBER
                          const name = String(p.name ?? "");         // ← ÉP VỀ STRING
