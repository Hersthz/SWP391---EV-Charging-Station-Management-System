import { ArrowLeft, Calendar, Download, TrendingUp, Zap, Battery, Clock } from "lucide-react";
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-foreground">System Report</h1>
                <p className="text-sm text-muted-foreground">Detailed statistics & analysis</p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Uptime and sessions</CardDescription>
            </CardHeader>
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Current status across stations</CardDescription>
            </CardHeader>
            <CardContent>
